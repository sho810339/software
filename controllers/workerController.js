...
const addWorker = async (req, res) => {
  const { given_name, family_name, age, country, passport_number, job_title } = req.body;
  try {
    const newWorker = await Worker.create({ given_name, family_name, age, country, passport_number, job_title });
